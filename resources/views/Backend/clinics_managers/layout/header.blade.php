<div class="header">
    <div class="header-left">
        <a href="{{ Route('clinic_manager_dashboard') }}" class="logo">
    ...
    <ul class="float-right nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" style="width: 40px; height:40px; margin-right:5px;" src="{{ asset($clinicManager?->image) }}" alt="">
                </span>
                <span>
                    Clinic Manager
                </span>
