...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Clinics offering this Department:</strong> {{ $department->clinics->count() }}</p>
                    <p><strong>Doctors in this Department:</strong> {{ $doctors->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3 d-flex justify-content-end">
            <a href="{{ route('clinic.view_departments') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                Back
            </a>
        </div>
