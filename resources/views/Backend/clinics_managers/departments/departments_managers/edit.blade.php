              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{ $department_manager->user->name }}">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" dir="ltr" lang="en" value="{{ $department_manager->user->date_of_birth }}">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" value="{{ $department_manager->user->phone }}">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="{{ $department_manager->user->email }}">
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="address" name="address" value="{{ $department_manager->user->address }}">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="profile-upload">
                      <div class="upload-img">
                        <img alt="manager image" src="{{ asset($department_manager->user->image ?? 'assets/img/user.jpg') }}">
                      </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <select name="work_start_time" id="work_start_time" class="form-control">
                      ...
                      @if($department_manager->work_start_time)
                        <option value="{{ $department_manager->work_start_time }}" selected>{{ $department_manager->work_start_time }}</option>
                      @endif
                    </select>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="input-group">
                    ...
                    <select name="work_end_time" id="work_end_time" class="form-control">
                      ...
                      @if($department_manager->work_end_time)
                        <option value="{{ $department_manager->work_end_time }}" selected>{{ $department_manager->work_end_time }}</option>
                      @endif
                    </select>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  @php
                    ...
                    $selectedDays = old('working_days', $department_manager->working_days ?? []);
                  @endphp
                  <div class="row gx-1">
                    <div class="col-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <textarea class="form-control" id="short_biography" name="short_biography" rows="3">{{ $department_manager->short_biography }}</textarea>
              </div>

              <div class="form-group">
                <label class="display-block">Status</label>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="status" id="manager_active" value="active" {{ $department_manager->status === 'active' ? 'checked' : '' }}>
                  <label class="form-check-label" for="manager_active">Active</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="status" id="manager_inactive" value="inactive" {{ $department_manager->status === 'inactive' ? 'checked' : '' }}>
...
@section('js')
@php
    $workStart = old('work_start_time', $department_manager->work_start_time ?? '');
    $workEnd   = old('work_end_time',   $department_manager->work_end_time   ?? '');
    $currentClinicId = $department_manager->clinic_id ?? '';
    $selectedDepartmentId = $department_manager->department->id ?? '';

    $origName = $department_manager->name;
    $origEmail = $department_manager->email;
    $origPhone = $department_manager->phone;
    $origAddress = $department_manager->address;
    $origGender = $department_manager->gender;
    $origDOB = $department_manager->date_of_birth;
    $origClinic = $department_manager->clinic_id ?? '';
    $origDepartment = $department_manager->department_id ?? '';
    $origWorkStart = $department_manage->work_start_time ?? '';
    $origWorkEnd = $department_manager->work_end_time ?? '';
    $origBio = $department_manager->short_biography ?? '';
    $origStatus = $department_manager->status ?? '';
    $origWorkingDays = $department_manager->working_days ?? [];
@endphp
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('clinic.update_department_manager', ['id' => $department_manager->id]) }}",
            data: formData,
            processData: false,
            contentType: false,
            headers: {
            ...
            if (response.data == 0) {
                ...
                }).then(() => window.location.href = '/clinic-manager/view/departments-managers');
            } else {
                Swal.fire({
                    title: 'Notice',
