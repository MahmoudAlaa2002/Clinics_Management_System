...
<div class="page-wrapper">
            ...
            <div class="col-lg-8">
                <div class="p-4 profile-card">
                    <div class="mb-4 text-center">
                        ...
                        <h2 class="mt-3 mb-0">{{ $department_manager->user->name }}</h2>
                        <p class="mb-1 text-muted">Department Manager</p>
                        <p class="text-primary fw-bold" style="font-size: 15px;">
                            [ {{ $department_manager->clinic->name }} - {{ $department_manager->department->name }} ]
                        </p>
                    </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <strong>Email:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->user->email }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-map-marker me-2 text-primary"></i>
                            <strong>Address:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->user->address }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-phone me-2 text-primary"></i>
                            <strong>Phone:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->user->phone ?? 'N/A' }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-clock me-2 text-primary"></i>
                            <strong>Work Start Time:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->work_start_time }} AM</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-calendar me-2 text-primary"></i>
                            <strong>Birth Date:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->user->date_of_birth }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-clock me-2 text-primary"></i>
                            <strong>Work End Time:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->work_end_time }} PM</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-venus-mars me-2 text-primary"></i>
                            <strong>Gender:</strong>&nbsp;
                            <span class="text-muted">{{ ucfirst($department_manager->user->gender) }}</span>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <span class="badge" style="background-color: #28C76F; color: white; padding:5px;">
                                {{ ucfirst($department_manager->status) }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4" style="margin-bottom: 20px;">
                        ...
                        @if($department_manager->working_days)
                            <ul>
                                @foreach($department_manager->working_days as $day)
                                    <li>{{ $day }}</li>
                                @endforeach
                            </ul>
                        @endif
                    ...
                    <div class="mb-4" style="margin-top:30px;">
                        ...
                        <div style="background-color: #f9f9f9; border-left: 4px solid #03A9F4; padding: 15px; border-radius: 10px; min-height: 100px; margin-left:20px;">
                            <p class="mb-0 text-muted">{{ $department_manager->short_biography ?? 'No biography provided.' }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mb-3 d-flex justify-content-end" style="margin-right: 240px;">
        <a href="{{ Route('clinic.view_departments_managers') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
            Back
        </a>
    </div>
</div>
