...
@section('title' , 'Edit Clinic Manager Profile')
    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title" style="margin-bottom:30px;">Edit Clinic Manager Profile</h4>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ route('clinic_manager_update_profile') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="card">
                        <div class="card-header">Clinic Manager Information</div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $clinicManager->name }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" dir="ltr" lang="en" value="{{ $clinicManager->date_of_birth }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" value="{{ $clinicManager->phone }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="email" id="email" name="email" value="{{ $clinicManager->email }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="address" name="address" value="{{ $clinicManager->address }}">
                                    </div>
                                </div>
