    ...
    <div class="content">
        <div class="row">
            ...
            <div class="text-right col-sm-8 col-9 m-b-20">
                <a href="{{ Route('clinic.add_employee') }}" class="float-right btn btn-primary btn-rounded" style="font-weight: bold;">
        ...
        <div id="employees_container">
            @include('Backend.clinics_managers.employees.search', ['employees' => $employees])
        </div>
    </div>
</div>
@endsection
...
<script>
    ...
    function fetchEmployees(url = "{{ route('clinic.search_employees') }}") {
        ...
        if (keyword === '' && lastEmployeeKeyword !== '') {
            lastEmployeeKeyword = '';
            window.location.href = "{{ route('clinic.view_employees') }}";
            return;
        }
    ...
    $(document).on('click', '.delete-employee', function () {
        ...
        let url = `/clinic-manager/delete/employee/${employeeId}`;
