...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ Route('clinic.store_patient') }}" enctype="multipart/form-data">
                    @csrf
            ...
            $('.addBtn').click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: "{{ route('clinic.store_patient') }}",
                            data: formData,
                            processData: false,
                            contentType: false,
                            headers: {
                            ...
                            success: function (response) {
                                if (response.data == 0) {
                                    ...
                                    Swal.fire({
                                        ...
                                        window.location.href = '/clinic-manager/view/patients';
                                    });
                                }
