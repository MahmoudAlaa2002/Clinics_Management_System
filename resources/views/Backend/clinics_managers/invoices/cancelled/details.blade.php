...
<div class="invoice-wrapper">
    ...
    <div class="action-buttons">
        <a href="{{ route('clinic.view_invoices') }}" class="btn-custom btn-back">Back</a>
        <a href="{{ route('clinic.cancelled_invoice_pdf' , ['id' =>$refund_invoice->id]) }}" class="btn-custom btn-print">Print</a>
    </div>
