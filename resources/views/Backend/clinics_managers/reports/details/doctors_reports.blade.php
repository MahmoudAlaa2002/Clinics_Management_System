...
@section('title', 'Clinic Doctors Reports')
...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stats-card text-center p-3">
                    ...
                    <h3 class="text-warning mb-0">{{ $departments_count }}</h3>
                </div>
            </div>
        ...
        <div class="mb-3 d-flex justify-content-end">
            <a href="{{ route('clinic.view_reports') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">Back</a>
        </div>
...
<script>
    ...
    fetch("{{ route('clinic_doctors_monthly') }}")
        .then(res => res.json())
        .then(data => {
