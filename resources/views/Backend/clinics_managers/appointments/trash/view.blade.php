...
<script>
    ...
    $(document).ready(function () {
        ...
        function fetchTrashAppointments(url = "{{ route('clinic.appointments_trash_search') }}") {
            ...
            if (keyword === '' && lastKeyword !== '') {
                lastKeyword = '';
                window.location.href = "{{ route('clinic.appointments_trash') }}";
                return;
            }
    ...
    $(document).on('click', '.restore-appointment', function () {
        ...
        let url = `/clinic-manager/appointments/restore/${appointmentId}`;
    ...
    $(document).on('click', '.force-delete-appointment', function () {
        ...
        let appointmentId = $(this).data('id');
        let url = `/clinic-manager/appointments/force-delete/${appointmentId}`;
