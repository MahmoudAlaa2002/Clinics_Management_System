...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ Route('clinic.store_appointment') }}" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.addBtn').click(function (e) {
                ...
                if (!isValidSelectValue('patient_id') || !isValidSelectValue('department_id') || !isValidSelectValue('doctor_id')
                    ...
                    $.ajax({
                    method: 'POST',
                    url: "{{ route('clinic.store_appointment') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    headers: {
