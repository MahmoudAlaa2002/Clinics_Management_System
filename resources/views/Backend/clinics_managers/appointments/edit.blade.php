...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ route('clinic.update_appointment', ['id' => $appointment->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="clinic_id" name="clinic_id" value="{{ $appointment->clinicDepartment->clinic->id }}">
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.editBtn').click(function (e) {
            ...
            if (!isValidSelectValue('department_id') || !isValidSelectValue('doctor_id')
                || !isValidSelectValue('appointment_time') || !isValidSelectValue('appointment_day')) {
            ...
            $.ajax({
                method: 'POST',
                url: "{{ route('clinic.update_appointment', ['id' => $appointment->id]) }}",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function (response) {
                        if (response.data == 0) {
                            ...
                            Swal.fire('Success', 'Appointment has been added successfully', 'success')
                                .then(() => {
                                window.location.href = '/clinic-manager/view/appointments';
                            });
                        }
                    }
            });
