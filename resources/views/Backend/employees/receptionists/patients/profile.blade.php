...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card-box">
            <div class="row">
                <div class="text-center col-md-4">
                    <img src="{{ $patient->user->image ? asset('storage/'.$patient->user->image) : asset('assets/img/user.jpg') }}" alt="Patient Image"
        ...
        <div class="mb-3 d-flex justify-content-end">
            <a href="{{ Route('receptionist.view_patients') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                Back
            </a>
        </div>
    </div>
