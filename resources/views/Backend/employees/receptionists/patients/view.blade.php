    ...
    <div class="content">
        <div class="row">
            ...
            <div class="text-right col-sm-8 col-9 m-b-20">
                <a href="{{ Route('receptionist.add_patient') }}" class="float-right btn btn-primary btn-rounded" style="font-weight: bold;">
        ...
        <div class="table-responsive">
            <table class="table mb-0 text-center table-bordered table-striped custom-table">
                ...
                <tbody id="patients_table_body">
                    @include('Backend.employees.receptionists.patients.search', ['patients' => $patients])
                </tbody>
            </table>
...
@section('js')
    <script>
        $(document).on('click', '.delete-patient', function () {
            ...
            let url = `/employee/receptionist/delete/patient/${patientId}`;
