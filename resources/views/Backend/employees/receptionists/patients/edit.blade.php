...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <form method="POST" action="{{ Route('receptionist.update_patient', ['id' => $patient->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-upload">
                                                <div class="upload-img">
                                                    <img alt="patient image" src="{{ asset('storage/'.$patient->user->image ?? 'assets/img/user.jpg') }}">
                                                </div>
...
<script>
    ...
    $(document).ready(function () {
        $('.editBtn').click(function (e) {
            ...
            $.ajax({
                method: 'POST',
                url: "{{ route('receptionist.update_patient', ['id' => $patient->id]) }}",
                data: formData,
                processData: false,
                contentType: false,
                headers: {
