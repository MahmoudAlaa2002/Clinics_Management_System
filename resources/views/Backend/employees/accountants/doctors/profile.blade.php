...
@section('content')
    ...
    <div class="page-wrapper">
                ...
                <div class="col-lg-8">
                    <div class="p-4 profile-card">
                        <div class="mb-4 text-center">
                            <img src="{{ $doctor->employee->user->image ? asset('storage/'.$doctor->employee->user->image) : asset('assets/img/user.jpg') }}" alt=""
                        ...
                        <div class="mb-4 row" style="margin-left:5px;">
                            ...
                            <div class="mb-3 col-md-6 profile-item">
                                ...
                                <span class="text-muted">{{ $invoicesCount }}</span>
                            </div>
        ...
        <div class="mb-3 d-flex justify-content-end" style="margin-right: 240px;">
            <a href="{{ Route('accountant.view_doctors') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                Back
            </a>
        </div>
    </div>
