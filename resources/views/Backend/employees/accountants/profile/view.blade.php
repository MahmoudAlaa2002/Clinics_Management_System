        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="p-4 profile-card">
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <span class="text-muted">{{ $accountant->date_of_birth }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-phone me-2 text-primary"></i>
                            <strong>Phone:</strong>&nbsp;
                            <span class="text-muted">{{ $accountant->phone ?? 'N/A' }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-venus-mars me-2 text-primary"></i>
                            <strong>Gender:</strong>&nbsp;
                            <span class="text-muted">{{ ucfirst($accountant->gender) }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-map-marker-alt me-2 text-primary"></i>
                            <strong>Address:</strong>&nbsp;
                            <span class="text-muted">{{ $accountant->address }}</span>
                        </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">{{ $accountant->employee->work_start_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="far fa-clock me-2 text-primary"></i>
                                <strong>Work End Time:</strong>&nbsp;
                                <span class="text-muted">{{ $accountant->employee->work_end_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="fa fa-calendar-day me-2 text-primary"></i>
                                <strong>Hire Date:</strong>&nbsp;
                                <span class="text-muted">{{ $accountant->employee->hire_date }}</span>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">
                                    @php
                                        $days = $accountant->employee->working_days ?? [];
                                    @endphp
                                    {{ implode(', ', $days) }}
                                </span>
                            </div>
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">{{ ucfirst($accountant->employee->status) }}</span>
                            </div>
                    ...
                    <div class="mb-4" style="background:#f9f9f9; padding:20px 25px; border-radius:12px; border-left:4px solid #03A9F4;">
                        <p class="text-muted" style="line-height:1.8; font-size:15px;">
                            {{ $accountant->employee->short_biography ?? 'No biography available.' }}
                        </p>
                    </div>
                ...
                <div class="mb-3 d-flex justify-content-end" style="margin-top:15px;">
                    <a href="{{ Route('accountant_dashboard') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                        Back
                    </a>
                </div>
            </div>
