...
@section('title', 'Hold Appointment Details')
...
<div class="page-wrapper">
                ...
                <div class="appointment-card">
                    ...
                    <div class="details-grid">
                        ...
                        <div class="detail-box">
                            ...
                            <div class="detail-value">{{ $hold_appointment->patient->user->name }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fa fa-hospital"></i></div>
                            <div class="detail-title">Clinic</div>
                            <div class="detail-value">{{ $hold_appointment->clinicDepartment->clinic->name }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fas fa-building"></i></div>
                            <div class="detail-title">Department</div>
                            <div class="detail-value">{{ $hold_appointment->clinicDepartment->department->name }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fas fa-user-md"></i></div>
                            <div class="detail-title">Doctor</div>
                            <div class="detail-value">{{ $hold_appointment->doctor->employee->user->name }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fas fa-calendar-day"></i></div>
                            <div class="detail-title">Date</div>
                            <div class="detail-value">{{ \Carbon\Carbon::parse($hold_appointment->date)->format('Y-m-d') }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fas fa-clock"></i></div>
                            <div class="detail-title">Time</div>
                            <div class="detail-value">{{ \Carbon\Carbon::parse($hold_appointment->time)->format('h:i A') }}</div>
                        </div>

                        <div class="detail-box">
                            <div class="detail-icon"><i class="fas fa-info-circle"></i></div>
                            <div class="detail-title">Status</div>
                                @if($hold_appointment->status === 'Pending')
                    ...
                    <div class="notes-section">
                        ...
                        <p class="mb-0">
                            {{ $hold_appointment->notes ? $appointment->notes : 'No notes provided.' }}
                        </p>
                    </div>
    ...
    <div class="mb-3 d-flex justify-content-end" style="margin-right: 80px;">
        <a href="{{ Route('accountant.bank_payments.pending') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
            Back
        </a>
    </div>
</div>
