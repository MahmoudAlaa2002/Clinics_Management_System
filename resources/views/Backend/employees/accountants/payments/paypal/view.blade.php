                ...
                <div class="table-responsive">
                    <table class="table mb-0 text-center table-bordered table-striped custom-table">
                        ...
                        <tbody id="payments_table_body">
                            @include('Backend.employees.accountants.payments.paypal.search', ['payments' => $payments])
                        </tbody>
                    </table>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        function fetchAppointments(url = "{{ route('accountant.search_paypal_payments') }}") {
            ...
            if (keyword === '' && lastAppointmentKeyword !== '') {
                ...
                window.location.href = "{{ route('accountant.view_paypal_payments') }}";
                return;
            }
