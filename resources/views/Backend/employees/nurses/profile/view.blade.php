            ...
            <div class="col-lg-8">
                <div class="p-4 profile-card">
                    <div class="mb-4 text-center">
                        <img src="{{ asset('storage/'.$nurse->image ?? 'assets/img/user.jpg') }}" alt=""
                            class="profile-image img-fluid rounded-circle" style="width: 150px; height:150px;">
                            <h2 class="mt-3 mb-0">{{ $nurse->name }}</h2>
                        <p class="text-muted">Nurse</p>

                        <p class="text-primary fw-semibold mb-0">
                            [ {{ $nurse->employee->clinic->name ?? '-' }}
                                &nbsp;•&nbsp;
                            {{ $nurse->employee->department->name ?? '-' }} ]
                        </p>
                    </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <strong>Email:</strong>&nbsp;
                            <span class="text-muted">{{ $nurse->email }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-calendar me-2 text-primary"></i>
                            <strong>Birth Date:</strong>&nbsp;
                            <span class="text-muted">{{ $nurse->date_of_birth }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-phone me-2 text-primary"></i>
                            <strong>Phone:</strong>&nbsp;
                            <span class="text-muted">{{ $nurse->phone ?? 'N/A' }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-venus-mars me-2 text-primary"></i>
                            <strong>Gender:</strong>&nbsp;
                            <span class="text-muted">{{ ucfirst($nurse->gender) }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-map-marker-alt me-2 text-primary"></i>
                            <strong>Address:</strong>&nbsp;
                            <span class="text-muted">{{ $nurse->address }}</span>
                        </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">{{ $nurse->employee->work_start_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="far fa-clock me-2 text-primary"></i>
                                <strong>Work End Time:</strong>&nbsp;
                                <span class="text-muted">{{ $nurse->employee->work_end_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="fa fa-calendar-day me-2 text-primary"></i>
                                <strong>Hire Date:</strong>&nbsp;
                                <span class="text-muted">{{ $nurse->employee->hire_date }}</span>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">
                                    @php
                                        $days = $nurse->employee->working_days ?? [];
                                    @endphp
                                    {{ implode(', ', $days) }}
                                </span>
                            </div>
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">{{ ucfirst($nurse->employee->status) }}</span>
                            </div>
                    ...
                    <div class="mb-4" style="background:#f9f9f9; padding:20px 25px; border-radius:12px; border-left:4px solid #03A9F4;">
                        <p class="text-muted" style="line-height:1.8; font-size:15px;">
                            {{ $nurse->employee->short_biography ?? 'No biography available.' }}
                        </p>
                    </div>
                ...
                <div class="mb-3 d-flex justify-content-end" style="margin-top:15px;">
                    <a href="{{ Route('nurse_dashboard') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                        Back
                    </a>
                </div>
            </div>
