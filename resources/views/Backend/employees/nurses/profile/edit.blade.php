...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <form method="POST" action="{{ route('nurse_update_profile') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="card">
                            <div class="card-header">nurse Information</div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" id="date_of_birth" name="date_of_birth" class="form-control" dir="ltr" lang="en" value="{{ $nurse->date_of_birth }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="email" id="email" name="email" value="{{ $nurse->email }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" id="address" name="address" value="{{ $nurse->address }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="profile-upload">
                                            <div class="upload-img">
                                                <img alt="admin image" src="{{ asset('storage/'.$nurse->image ?? 'assets/img/user.jpg') }}">
                                            </div>
