    ...
    <ul class="float-right nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" style="width: 40px; height:40px; margin-right:5px;" src="{{ asset($user->image) }}" alt="Doctor">
                </span>
                <span>
                    Doctor
                </span>
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('doctor_profile') }}">My Profile</a>
                <a class="dropdown-item" href="{{ route('doctor_edit_profile') }}">Edit Profile</a>
