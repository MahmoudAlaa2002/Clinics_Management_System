    ...
    <div class="content">
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="vs-card">
                    <div class="d-flex justify-content-between align-items-center vs-title">
                        ...
                        <a href="{{ route('doctor.assign_task', [
                                'appointment' => $vitalSigns->appointment_id,
                                'nurse'       => $vitalSigns->nurse_id
                            ]) }}"
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 text-right">
                <a href="{{ url()->previous() }}" class="btn btn-primary rounded-pill px-4 py-2" style="font-weight: bold;">
                    Back
                </a>
            </div>
        </div>
