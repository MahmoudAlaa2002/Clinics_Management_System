...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="POST" action="{{ route('doctor_update_profile') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="email" id="email" name="email" value="{{ $doctor->email }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="address" name="address" value="{{ $doctor->address }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="profile-upload">
                                        <div class="upload-img">
                                            <img alt="admin image" src="{{ asset('storage/'.$doctor->image ?? 'assets/img/user.jpg') }}">
                                        </div>
...
$(document).ready(function () {
    ...
    let originalName         = "{{ $doctor->name }}";
    let originalDob          = "{{ $doctor->date_of_birth }}";
    let originalEmail        = "{{ $doctor->email }}";
    let originalPhone        = "{{ $doctor->phone }}";
    let originalAddress      = "{{ $doctor->address }}";
    let originalGender       = "{{ $doctor->gender }}";
    ...
    $('.editBtn').click(function (e) {
        ...
        $.ajax({
            ...
            success: function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('doctor_update_profile') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    headers: {
