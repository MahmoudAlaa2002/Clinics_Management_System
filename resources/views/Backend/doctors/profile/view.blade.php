            ...
            <div class="col-lg-8">
                <div class="p-4 profile-card">
                    <div class="mb-4 text-center">
                        <img src="{{ asset($doctor->image ?? 'assets/img/user.jpg') }}" alt=""
                        ...
                        <p class="text-primary fw-semibold mb-0">
                            [ {{ $doctor->employee->clinic->name ?? '-' }}
                                &nbsp;•&nbsp;
                            {{ $doctor->employee->department->name ?? '-' }} ]
                        </p>
                    </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <strong>Phone:</strong>&nbsp;
                            <span class="text-muted">{{ $doctor->phone ?? 'N/A' }}</span>
                        </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">{{ $doctor->employee->work_start_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="far fa-clock me-2 text-primary"></i>
                                <strong>Work End Time:</strong>&nbsp;
                                <span class="text-muted">{{ $doctor->employee->work_end_time }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="fa fa-calendar-day me-2 text-primary"></i>
                                <strong>Hire Date:</strong>&nbsp;
                                <span class="text-muted">{{ $doctor->employee->hire_date }}</span>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 profile-item d-flex align-items-center">
                                ...
                                <span class="text-muted">${{ ucfirst($doctor->employee->doctor->consultation_fee) }}</span>
                            </div>

                            <div class="mb-3 profile-item d-flex align-items-center">
                                <i class="fas fa-user-check me-2 text-primary"></i>
                                <strong>Status:</strong>&nbsp;
                                <span class="text-muted">{{ ucfirst($doctor->employee->status) }}</span>
                            </div>
                    ...
                    <div class="mb-4" style="background:#f9f9f9; padding:20px 25px; border-radius:12px; border-left:4px solid #03A9F4;">
                        <p class="text-muted" style="line-height:1.8; font-size:15px;">
                            {{ $doctor->employee->short_biography ?? 'No biography available.' }}
                        </p>
                    </div>
                </div>
                <div class="mb-3 d-flex justify-content-end" style="margin-top:15px;">
                    <a href="{{ Route('doctor_dashboard') }}" class="btn btn-primary rounded-pill" style="font-weight: bold;">
                        Back
                    </a>
                </div>
            </div>
