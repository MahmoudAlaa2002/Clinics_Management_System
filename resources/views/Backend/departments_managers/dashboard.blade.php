					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('department.view_appointments') }}" class="float-right btn btn-primary">View all</a>
                            </div>
                                                ...
                                                <tr>
                                                    <td style="min-width: 200px;">
                                                        @if($appointment->patient && $appointment->patient->user)
                                                            <a class="avatar"
                                                               href="{{ route('department.profile_patient', ['id' => $appointment->patient->id]) }}">
                                                        ...
                                                        @if($appointment->patient && $appointment->patient->user)
                                                            <h2>
                                                                <a href="{{ route('department.profile_patient', ['id' => $appointment->patient->id]) }}">
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{ route('department.details_appointment', ['id' => $appointment->id]) }}"
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                                            ...
                                            <li>
                                                <div class="contact-cont">
                                                    <div class="float-left user-img m-r-10">
                                                        <a href="{{ route('department.profile_doctor' , ['id' => $doctor->id]) }}" title="{{ $doctor->employee->user->name }}">
                                                            <img src="{{ $doctor->employee->user->image ? asset('storage/'.$doctor->employee->user->image)
                                                                : asset('assets/img/user.jpg') }}" alt="" class="w-40 rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="contact-info">
                                                        <a href="{{ route('department.profile_doctor' , ['id' => $doctor->id]) }}"
                            ...
                            <div class="text-center bg-white card-footer">
                                <a href="{{ route('department.view_doctors') }}" class="text-muted">View all Doctors</a>
                            </div>
                        </div>
                    </div>
				</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-8 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('department.view_patients') }}" class="float-right btn btn-primary">View all</a>
                            </div>
                                        ...
                                        <table class="table mb-0 new-patient-table">
                                            <tbody>
                                                @foreach ($patients as $patient)
                                                    <tr>
                                                        <td>
                                                            <img width="34" height="34" class="rounded-circle" src="{{ $patient->user->image ? asset('storage/'.$patient->user->image)
                                                                : asset('assets/img/user.jpg') }}" alt="">
                                                            <h2>{{ $patient->user->name  }}</h2>
                                                        </td>
                                                        <td>{{ $patient->user->email }}</td>
                                                        <td>{{ $patient->user->phone }}</td>
                                                        <td>
                                                            <a href="{{ route('department.profile_patient', ['id' => $patient->id]) }}"
