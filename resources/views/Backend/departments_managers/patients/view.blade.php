        ...
        <div class="table-responsive">
            <table class="table mb-0 text-center table-bordered table-striped custom-table">
                ...
                <tbody id="patients_table_body">
                    @include('Backend.departments_managers.patients.search', ['patients' => $patients])
                </tbody>
            </table>
...
@section('js')
    <script>
        ...
        function fetchPatients(url = "{{ route('department.search_patients') }}") {
            ...
            if (keyword === '' && lastKeyword !== '') {
                lastKeyword = '';
                window.location.href = "{{ route('department.view_patients') }}";
                return;
            }
