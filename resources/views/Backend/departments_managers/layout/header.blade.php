...
<div class="header">
    <div class="header-left">
        <a href="{{ Route('department_manager_dashboard') }}" class="logo">
    ...
    <ul class="float-right nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('department_manager_profile') }}"><i class="fa fa-user"></i> My Profile</a>
                <a class="dropdown-item" href="{{ route('department_manager_edit_profile') }}"><i class="fa fa-edit"></i> Edit Profile</a>
