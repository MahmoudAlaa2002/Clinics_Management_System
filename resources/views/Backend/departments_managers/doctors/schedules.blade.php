    ...
    <div class="content">
        <div>
            ...
            <div class="card-body" style="margin-top: 50px;">
                <form id="doctor-schedule-form" method="POST" action="{{ route('department.search_doctor_schedule') }}">
                    @csrf
                    <div class="mb-3 row">
                        <div class="col-md-4">
                            <label>Clinic</label>
                                            ...
                                            @foreach ($timeSlots as $slot)
                                                ...
                                                <td>
                                                    @if(isset($appointmentsGrouped[$key]))
                                                        <a href="{{ route('department.details_appointment', $appointmentsGrouped[$key]->first()->id) }}"
