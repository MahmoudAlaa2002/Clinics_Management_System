            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card report-card text-center shadow-sm" style="border-top: 5px solid #00A8FF;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('details_patients_reports') }}" class="btn btn-outline-primary">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card report-card text-center shadow-sm" style="border-top: 5px solid #28A745;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('details_appointments_reports') }}" class="btn btn-outline-success">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card report-card text-center shadow-sm" style="border-top: 5px solid #E83E8C;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('details_invoices_reports') }}" class="btn btn-outline-danger">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card report-card text-center shadow-sm" style="border-top: 5px solid #ffc107;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('details_doctors_reports') }}" class="btn btn-outline-warning">View Details</a>
                    </div>
                </div>
            </div>
