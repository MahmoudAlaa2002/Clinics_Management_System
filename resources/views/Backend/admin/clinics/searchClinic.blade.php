        ...
        <tr style="vertical-align: middle;">
            ...
            <td class="action-btns">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('details_clinic', ['id' => $clinic->id]) }}" class="mr-1 btn btn-outline-success btn-sm" data-bs-toggle="tooltip" title="Details Clinic">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{ route('edit_clinic', ['id' => $clinic->id]) }}" class="mr-1 btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" title="Edit Clinic">
                        <i class="fa fa-edit"></i>
                    </a>
                    <button class="btn btn-outline-danger btn-sm delete-clinic" data-id="{{ $clinic->id }}" data-bs-toggle="tooltip" title="Delete Clinic">
