...
<div class="page-wrapper">
            ...
            <div class="col-lg-8">
                <div class="p-4 profile-card">
                    <div class="mb-4 text-center">
                        <img src="{{ $department_manager->image ? asset($department_manager->image) : asset('assets/img/user.jpg') }}"
                             alt="clinic Manager Image"
                             class="profile-image img-fluid rounded-circle" style="width: 150px; height:150px;">
                        <h2 class="mt-3 mb-0">{{ $department_manager->name }}</h2>
                        <p class="mb-1 text-muted">Department Manager</p>
                        <p class="text-primary fw-bold" style="font-size: 15px;">
                            [ {{ $department_manager->employee->clinic->name }} - {{ $department_manager->employee->department->name }} ]
                        </p>
                    </div>
                    ...
                    <div class="mb-4 row" style="margin-left:5px;">
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <strong>Email:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->email }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-map-marker me-2 text-primary"></i>
                            <strong>Address:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->address }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-phone me-2 text-primary"></i>
                            <strong>Phone:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->phone ?? 'N/A' }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-clock me-2 text-primary"></i>
                            <strong>Work Start Time:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->employee->work_start_time }} AM</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-calendar me-2 text-primary"></i>
                            <strong>Birth Date:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->date_of_birth }}</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fa fa-clock me-2 text-primary"></i>
                            <strong>Work End Time:</strong>&nbsp;
                            <span class="text-muted">{{ $department_manager->employee->work_end_time }} PM</span>
                        </div>

                        <div class="mb-3 col-md-6 profile-item">
                            <i class="fas fa-venus-mars me-2 text-primary"></i>
                            <strong>Gender:</strong>&nbsp;
                            <span class="text-muted">{{ ucfirst($department_manager->gender) }}</span>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 profile-item">
                            ...
                            <span class="badge" style="background-color: #28C76F; color: white; padding:5px;">
                                {{ ucfirst($department_manager->employee->status) }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4" style="margin-bottom: 20px;">
                        ...
                        @if($department_manager->employee->working_days)
                            <ul>
                                @foreach($department_manager->employee->working_days as $day)
                                    <li>{{ $day }}</li>
                                @endforeach
                            </ul>
                        @endif
                    ...
                    <div class="mb-4" style="margin-top:30px;">
                        ...
                        <div style="background-color: #f9f9f9; border-left: 4px solid #03A9F4; padding: 15px; border-radius: 10px; min-height: 100px; margin-left:20px;">
                            <p class="mb-0 text-muted">{{ $department_manager->employee->short_biography ?? 'No biography provided.' }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mb-3 d-flex justify-content-end" style="margin-right: 245px;">
