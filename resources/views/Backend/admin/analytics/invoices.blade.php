...
@section('title', 'Invoices Analytics')
        ...
        <div class="mb-4 row">
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h3 class="mb-0 text-primary">{{ $invoices_count }}</h3>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h5 class="fw-bold text-secondary">Issued Invoices</h5>
                    <h3 class="mb-0 text-primary">{{ $issued_invoices }}</h3>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h5 class="fw-bold text-secondary">Cancelled Invoices</h5>
                    <h3 class="mb-0 text-primary">{{ $cancelled_invoices }}</h3>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h3 class="mb-0 text-success">{{ $paid_invoices }}</h3>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h3 class="mb-0 text-warning">{{ $partially_paid_invoices }}</h3>
                </div>
            </div>
            ...
            <div class="mb-3 col-md-3 col-sm-6">
                <div class="p-3 text-center stats-card">
                    ...
                    <h3 class="mb-0 text-danger">{{ $unpaid_invoices }}</h3>
                </div>
            </div>
        </div>
