                ...
                <div class="table-responsive">
                    <table class="table mb-0 text-center table-bordered table-striped custom-table">
                        ...
                        <tbody id="payments_table_body">
                            @include('Backend.admin.payments.bank.search', ['payments' => $payments])
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function () {
        ...
        function fetchAppointments(url = "{{ route('search_bank_payments') }}") {
            ...
            if (keyword === '' && lastAppointmentKeyword !== '') {
                ...
                window.location.href = "{{ route('view_bank_payments') }}";
                return;
            }
