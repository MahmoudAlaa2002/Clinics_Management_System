...
class DoctorController extends Controller{
    ...
    public function viewDoctors(){
        ...
        return view('Backend.employees.nurses.doctors.view', compact('doctors'));
    }
    ...
    public function searchDoctors(Request $request){
        ...
        $html = view('Backend.employees.nurses.doctors.search', compact('doctors'))->render();
    ...
    public function searchSchedules(){
        ...
        return view('Backend.employees.nurses.doctors.schedules', compact(
            'clinic',
            'department',
            'doctors'
        ));
