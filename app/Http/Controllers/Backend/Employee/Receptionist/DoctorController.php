...
class DoctorController extends Controller{
    ...
    public function viewDoctors(){
        ...
        return view('Backend.employees.receptionists.doctors.view', compact('doctors'));
    }
    ...
    public function searchDoctors(Request $request){
        ...
        $html = view('Backend.employees.receptionists.doctors.search', compact('doctors'))->render();
    ...
    public function profileDoctor($id){
        ...
        return view('Backend.employees.receptionists.doctors.profile', compact('doctor'));
    }
    ...
    public function searchSchedules(){
        ...
        return view('Backend.employees.receptionists.doctors.schedules', compact(
            'clinic',
            'department',
            'doctors'
        ));
    ...
    public function searchDoctchedule(Request $request){
        ...
        return view('Backend.employees.receptionists.doctors.schedules', [
            'clinic'         => $clinic,
